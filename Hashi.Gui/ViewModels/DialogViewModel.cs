...
namespace Hashi.Gui.ViewModels
{
    ...
    public class DialogViewModel : BaseViewModel
    {
        ...
        private bool isAsterisk, isError, isExclamation, isHand, isInformation, isNone, isQuestion, isStop, isWarning, isSuccess;
        ...
        public DialogViewModel(string? caption, string? message, DialogButton button = DialogButton.Ok, DialogImage image = DialogImage.None)
        {
        ...
        /// </summary>
        public bool IsAsterisk { get => isAsterisk; set => Set(ref isAsterisk, value); }

        /// <summary>
        /// The IsSuccess property.
        /// </summary>
        public bool IsSuccess { get => isSuccess; set => Set(ref isSuccess, value); }
        ...
        /// </summary>
        public bool IsExclamation { get => isExclamation; set => Set(ref isExclamation, value); }

        /// <summary>
        /// The IsHand property.
        /// </summary>
        public bool IsHand { get => isHand; set => Set(ref isHand, value); }

        /// <summary>
        /// The IsNone property.
        /// </summary>
        public bool IsInformation { get => isInformation; set => Set(ref isInformation, value); }

        /// <summary>
        /// The IsNone property.
        /// </summary>
        public bool IsNone { get => isNone; set => Set(ref isNone, value); }

        /// <summary>
        /// The IsQuestion property.
        /// </summary>
        public bool IsQuestion { get => isQuestion; set => Set(ref isQuestion, value); }

        /// <summary>
        /// The IsStop property.
        /// </summary>
        public bool IsStop { get => isStop; set => Set(ref isStop, value); }

        /// <summary>
        /// The IsWarning property.
        /// </summary>
        public bool IsWarning { get => isWarning; set => Set(ref isWarning, value); }

        /// <summary>
        /// The ShowOk property.
        /// </summary>
        public bool ShowOk { get => showOk; set => Set(ref showOk, value); }

        /// <summary>
        /// The ShowCancel property.
        /// </summary>
        public bool ShowCancel { get => showCancel; set => Set(ref showCancel, value); }

        /// <summary>
        /// The ShowYesNo property.
        /// </summary>
        public bool ShowYesNo { get => showYesNo; set => Set(ref showYesNo, value); }
        ...
        {
            (IsAsterisk, IsError, IsExclamation, IsHand, IsInformation, IsNone, IsQuestion, IsStop, IsWarning, IsSuccess) = image switch
            {
