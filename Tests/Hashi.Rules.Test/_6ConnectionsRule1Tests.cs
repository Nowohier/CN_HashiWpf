...
/// <summary>
/// Unit tests for _6ConnectionsRule1 class.
/// </summary>
public class _6ConnectionsRule1Tests : TestBase<_6ConnectionsRule1>
{
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _6ConnectionsRule1(null!, IslandProviderMock.Object);
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _6ConnectionsRule1(RuleInfoProviderMock.Object, null!);
    ...
    {
        // Arrange & Act
        var result = new _6ConnectionsRule1(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Assert
        result.Should().NotBeNull();
        result.Should().BeOfType<_6ConnectionsRule1>();
    }
    [Test]
    public void RuleMessage_WhenAccessed_ShouldReturnExpectedValue()
    {
        // Arrange
        var rule = new _6ConnectionsRule1(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Act
        var ruleMessageProperty = typeof(_6ConnectionsRule1).GetProperty("RuleMessage", 
