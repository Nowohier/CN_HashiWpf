...
/// <summary>
/// Unit tests for _9GeneralRule2 class.
/// </summary>
public class _9GeneralRule2Tests : TestBase<_9GeneralRule2>
{
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _9GeneralRule2(null!, IslandProviderMock.Object);
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _9GeneralRule2(RuleInfoProviderMock.Object, null!);
    ...
    {
        // Arrange & Act
        var result = new _9GeneralRule2(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Assert
        result.Should().NotBeNull();
        result.Should().BeOfType<_9GeneralRule2>();
    }
    [Test]
    public void RuleMessage_WhenAccessed_ShouldReturnExpectedValue()
    {
        // Arrange
        var rule = new _9GeneralRule2(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Act
        var ruleMessageProperty = typeof(_9GeneralRule2).GetProperty("RuleMessage", 
