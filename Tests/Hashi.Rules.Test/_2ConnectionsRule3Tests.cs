...
/// <summary>
/// Unit tests for _2ConnectionsRule3 class.
/// </summary>
public class _2ConnectionsRule3Tests : TestBase<_2ConnectionsRule3>
{
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _2ConnectionsRule3(null!, IslandProviderMock.Object);
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _2ConnectionsRule3(RuleInfoProviderMock.Object, null!);
    ...
    {
        // Arrange & Act
        var result = new _2ConnectionsRule3(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Assert
        result.Should().NotBeNull();
        result.Should().BeOfType<_2ConnectionsRule3>();
    }
