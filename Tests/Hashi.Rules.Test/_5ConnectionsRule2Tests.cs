...
/// <summary>
/// Unit tests for _5ConnectionsRule2 class.
/// </summary>
public class _5ConnectionsRule2Tests : TestBase<_5ConnectionsRule2>
{
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _5ConnectionsRule2(null!, IslandProviderMock.Object);
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _5ConnectionsRule2(RuleInfoProviderMock.Object, null!);
    ...
    {
        // Arrange & Act
        var result = new _5ConnectionsRule2(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Assert
        result.Should().NotBeNull();
        result.Should().BeOfType<_5ConnectionsRule2>();
    }
    [Test]
    public void RuleMessage_WhenAccessed_ShouldReturnExpectedValue()
    {
        // Arrange
        var rule = new _5ConnectionsRule2(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Act
        var ruleMessageProperty = typeof(_5ConnectionsRule2).GetProperty("RuleMessage", 
