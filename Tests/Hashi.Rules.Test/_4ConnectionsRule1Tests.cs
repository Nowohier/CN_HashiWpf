...
/// <summary>
/// Unit tests for _4ConnectionsRule1 class.
/// </summary>
public class _4ConnectionsRule1Tests : TestBase<_4ConnectionsRule1>
{
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _4ConnectionsRule1(null!, IslandProviderMock.Object);
    ...
    {
        // Arrange & Act & Assert
        var action = () => new _4ConnectionsRule1(RuleInfoProviderMock.Object, null!);
    ...
    {
        // Arrange & Act
        var result = new _4ConnectionsRule1(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Assert
        result.Should().NotBeNull();
        result.Should().BeOfType<_4ConnectionsRule1>();
    }
    [Test]
    public void RuleMessage_WhenAccessed_ShouldReturnExpectedValue()
    {
        // Arrange
        var rule = new _4ConnectionsRule1(RuleInfoProviderMock.Object, IslandProviderMock.Object);

        // Act
        var ruleMessageProperty = typeof(_4ConnectionsRule1).GetProperty("RuleMessage", 
