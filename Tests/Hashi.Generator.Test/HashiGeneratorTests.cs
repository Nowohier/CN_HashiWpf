...
public class HashiGeneratorTests
{
    ...
    private Mock<Func<int[][], IReadOnlyList<IBridgeCoordinates>, ISolutionProvider>> solutionContainerFactoryMock = null!;

    [SetUp]
    public void Setup()
    {
        // Arrange - Set up mocks
        hashiSolverMock = new Mock<IPuzzleSolver>(MockBehavior.Strict);
        ...
        solutionContainerFactoryMock = new Mock<Func<int[][], IReadOnlyList<IBridgeCoordinates>, ISolutionProvider>>(MockBehavior.Strict);
