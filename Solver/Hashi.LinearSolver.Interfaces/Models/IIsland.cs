...
public interface IIsland
{
    ...
    /// </summary>
    IReadOnlyList<int> Neighbors { get; }

    /// <summary>
    /// Adds a neighboring island's ID to this island's neighbor list.
    /// </summary>
    /// <param name="neighborId">The ID of the neighboring island.</param>
